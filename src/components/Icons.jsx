export const Icon = ({ name, className = 'w-5 h-5' }) => {
  const icons = {
    ...
    chevronDownSmall: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />,
    ...
    arrowRight: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4M20 12l-6-6m6 6l-6 6" />,
...
export const StarRating = ({ rating = 5, size = 'text-xs' }) => (
...
export const PaymentIcon = ({ name, className = 'h-6' }) => {
  const icons = {
    visa: (
      <svg viewBox="0 0 48 32" className={className}>
        <rect width="48" height="32" rx="4" fill="#1A1F71" />
        <text x="24" y="21" textAnchor="middle" fill="white" fontFamily="Arial Black" fontSize="12" fontWeight="900" fontStyle="italic">VISA</text>
      </svg>
    ),
    mastercard: (
      <svg viewBox="0 0 48 32" className={className}>
        ...
        <path d="M 24 10 A 8 8 0 0 0 24 22 A 8 8 0 0 0 24 10" fill="#FF5F00" />
      </svg>
    ),
    amex: (
      <svg viewBox="0 0 48 32" className={className}>
        <rect width="48" height="32" rx="4" fill="#006FCF" />
        <text x="24" y="19" textAnchor="middle" fill="white" fontFamily="Arial" fontSize="7" fontWeight="900">AMEX</text>
      </svg>
    ),
    paypal: (
      <svg viewBox="0 0 48 32" className={className}>
        <rect width="48" height="32" rx="4" fill="#F7F7F7" />
        <text x="24" y="20" textAnchor="middle" fontFamily="Arial" fontSize="9" fontWeight="900">
    ...
    applepay: (
      <svg viewBox="0 0 48 32" className={className}>
        ...
        <text x="24" y="20" textAnchor="middle" fill="white" fontFamily="Arial" fontSize="9" fontWeight="600">
          <tspan fontSize="11"></tspan>Pay
        </text>
      </svg>
    ),
    googlepay: (
      <svg viewBox="0 0 48 32" className={className}>
        <rect width="48" height="32" rx="4" fill="#FFFFFF" stroke="#DADCE0" />
        <text x="24" y="20" textAnchor="middle" fontFamily="Arial" fontSize="8" fontWeight="700">
    ...
    stripe: (
      <svg viewBox="0 0 48 32" className={className}>
        ...
        <text x="24" y="20" textAnchor="middle" fill="white" fontFamily="Arial" fontSize="9" fontWeight="900">stripe</text>
      </svg>
    ),
  };
...
export const SocialIcon = ({ name, className = 'w-5 h-5' }) => {
  const icons = {
    facebook: <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.323-.593 1.323-1.325V1.325C24 .593 23.407 0 22.675 0z" />,
